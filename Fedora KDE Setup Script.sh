...
mainmenu () {
	clear
 	tput setaf 3
	echo "====================================="
	echo " --- Fedora KDE Setup Script 5.0 ---"
	echo "====================================="
